...
class report_complaints(models.Model):
    _name = 'report.complaints'
    _description = 'Contains Reports for Customer Complaints model'
    _auto = False
    ...
    status = fields.Selection(
       selection=[('open', 'Open'), ('in_progress', 'In Progress'),('resolved','Resolved'),('closed','Closed')])
    ...
    def _select_fields(self):
        ...
        customer_complaint.status AS status,
